...
REDIS_URL = "redis://:ssacgang@34.136.227.208:6379"
...
if user_input:= st.chat_input("텍스트를 입력하세요."):
    ...
    with st.chat_message("assistant"):
        ...
        llm = ChatOpenAI(streaming=True, callbacks=[stream_handler],model='solar-mini',api_key=api_key)
